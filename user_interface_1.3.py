from tkinter import filedialog, Tk, Entry, Checkbutton, Button, Label, StringVar, Listbox, END, Frame, LEFT, BOTTOM, \
    TOP, SINGLE, TclError, messagebox, IntVar, Toplevel

from sqlalchemy import select, desc
from sqlalchemy.orm import sessionmaker
from base import engine, TagList
import pickle
                ...
                while True:
                    ...
                    while True:
                        try:
                            ...
                            download_progress["text"] =  "pictures downloaded:" + str(i + 1 + pid * posts_pulled_per_request)
...
def tag_finder(search):
    ...
    try:
        ...
        messagebox.showerror("" , "this tag does not exist in the current program database. You can still try downloading pictures with this tag")
    else:
